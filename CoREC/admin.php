...
<body style="background-color: rgb(24,188,156);">
    ...
    <header class="masthead bg-primary text-white text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col"><a class="btn btn-light border rounded-0 border-dark shadow-sm" role="button" href="selection" style="width: 100%;">Check Data Input</a>
                </div>
                <div class="col" style="width: 100%;"><a class="btn btn-light border rounded-0 border-dark shadow-sm" role="button" href="remove" style="width: 100%;">Edit Account</a></div>
            </div>
        </div>
    </header>
