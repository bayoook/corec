...
<body style="background-color: rgb(24,188,156);">
    ...
    <header class="masthead bg-primary text-white text-center">
        <h1 style="padding-bottom: 28px;">Selamat Datang Perusahaan</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <a class="btn btn-light border rounded-0 border-dark shadow-sm" role="button" href="input_perusahaan" style="width: 100%;">Input Perusahaan</a>
                </div>
                <div class="col" style="width: 100%;">
                    <a class="btn btn-light border rounded-0 border-dark shadow-sm" role="button" href="show_resume" style="width: 100%;">Lihat Resume</a>
                </div>
                <div class="col">
                    <a class="btn btn-light border rounded-0 border-dark shadow-sm" role="button" href="show_mahasiswa" style="width: 100%;">Lihat Mahasiswa</a>
                </div>
            </div>
        </div>
    </header>
